...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-20 md:bottom-8 left-4 md:left-8 z-50 flex flex-col items-start select-none">
        ...
        <div className="mb-3 w-[330px] sm:w-[380px] bg-white rounded-2xl shadow-2xl border border-zinc-200 overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-200">
          ...
          <div className="p-3 bg-white border-t border-zinc-100 flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => handleSend()}
                className="p-2.5 rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white shadow-md transition-colors shrink-0 flex items-center justify-center cursor-pointer"
                title="Send Message"
              >
      ...
      <div className="flex items-center gap-2.5">
        <button
          ...
          className="group relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-2xl hover:scale-105 hover:bg-[#20ba59] transition-all duration-300 p-3.5 ring-4 ring-[#25D366]/20 cursor-pointer"
